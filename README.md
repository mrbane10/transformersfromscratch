...
Plain textANTLR4BashCC#CSSCoffeeScriptCMakeDartDjangoDockerEJSErlangGitGoGraphQLGroovyHTMLJavaJavaScriptJSONJSXKotlinLaTeXLessLuaMakefileMarkdownMATLABMarkupObjective-CPerlPHPPowerShell.propertiesProtocol BuffersPythonRRubySass (Sass)Sass (Scss)SchemeSQLShellSwiftSVGTSXTypeScriptWebAssemblyYAMLXML`   MetricScoreBLEU Score0.4391Character Error Rate (CER)0.3588Word Error Rate (WER)0.5303Parameters~64M   `
...
1.  git clone https://github.com/yourusername/transformers-from-scratch.gitcd transformers-from-scratch
...
To use your own dataset, modify the get\_ds() function in train.py:
